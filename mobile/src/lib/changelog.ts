...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    build: "39",
    title:
      "Silencieux par conversation, discussions d'événement dans les messages, listes communes finalisées",
    note: "Merci de signaler tout ce qui bloque. Les points marqués ⚠️ nécessitent la nouvelle version du serveur.",
    items: [
      "🔕 ⚠️ Une cloche dans l'en-tête de chaque discussion, privée comme d'événement, pour couper les notifications 1 heure, 8 heures, 1 semaine ou jusqu'à réactivation. La conversation reste dans ta liste avec ses messages non lus : seule la sonnerie s'arrête.",
      "🔔 ⚠️ Réglages de notifications par événement, ouverts à tous les participants et plus seulement à l'organisateur. Jusqu'ici, faire taire un seul événement obligeait à couper la catégorie « Événements » entière, donc tous les autres avec. L'annulation et le changement de date restent toujours notifiés — ce sont les seuls messages qu'on ne peut pas se permettre de rater.",
      "🔕 ⚠️ L'interrupteur « messages du chat » des réglages d'un événement n'avait aucun effet : le réglage était enregistré puis perdu. Il coupait de surcroît les notifications de tous les invités, pas seulement celles de l'organisateur.",
      "📩 ⚠️ En envoyant un message dans le chat d'un événement, l'organisateur recevait deux notifications sur son téléphone pour un seul message.",
      "💬 ⚠️ Les discussions d'événement apparaissent dans l'écran Discussions, sous un onglet « Événements » avec leur compteur de non-lus. Elles n'étaient joignables qu'en rouvrant l'événement.",
      "🎉 Le chat d'un événement porte son nom en titre, et un bandeau ramène à l'événement d'un geste. Ouvert depuis la liste des discussions, cet écran était une impasse : on lisait un message parlant de la date ou d'un cadeau sans pouvoir rejoindre l'endroit où en décider.",
      "📅 ⚠️ L'organisateur peut enfin retenir une date ou un lieu directement depuis les résultats du vote. Il fallait jusqu'ici passer par « Modifier l'événement » et rebasculer la date en mode fixe, sans plus avoir les décomptes sous les yeux au moment de choisir. Retenir un lieu prévient désormais les participants en le nommant.",
      "🗳️ ⚠️ Les votes des invités sans compte n'étaient comptés nulle part sur les cadeaux : seuls ceux des membres apparaissaient.",
      "🔐 ⚠️ Correctif de sécurité : les identifiants de session des invités sans compte étaient exposés dans les réponses du serveur, sur les propositions de cadeaux. N'importe quel participant pouvait les lire et se faire passer pour eux.",
      "👤 ⚠️ Un invité sans compte qui se connecte ou s'inscrit depuis un événement retrouve sa participation sur son compte : sa réponse de présence, ses votes et ses idées cadeaux le suivent au lieu d'être perdus.",
      "⌨️ Dans la fenêtre d'annulation d'un événement, le clavier masquait le champ du motif — on écrivait à l'aveugle. Et clavier ouvert, le premier appui sur un bouton était avalé : il fallait appuyer deux fois.",
      "💶 ⚠️ Le coût d'un remboursement de cagnotte est calculé sur les frais réellement prélevés au paiement, et non plus estimé au tarif d'une carte européenne standard. Une carte professionnelle ou étrangère coûte jusqu'à deux fois plus, et le montant annoncé avant de valider pouvait donc être très en dessous de la réalité.",
      "📜 En ouvrant une cagnotte, un encadré rappelle ce à quoi tu t'engages : en cas d'annulation, c'est à toi de rembourser, et les frais du paiement d'origine restent à ta charge.",
      "🎁 ⚠️ Listes communes — les gestionnaires voient enfin les réservations faites depuis le lien public. Elles n'apparaissaient nulle part dans l'application : l'idée semblait libre alors que quelqu'un s'en occupait déjà.",
      "↩️ ⚠️ Listes communes — un gestionnaire peut libérer la réservation de quelqu'un d'autre. Sans ça, une idée réservée par un visiteur qui ne revient jamais restait bloquée pour toujours.",
      "🙈 ⚠️ Listes communes — masquer une idée aux invités et au lien public, tout en la gardant visible entre gestionnaires.",
      "🔎 Listes communes — filtre par occasion et par état de réservation (libres, réservées, celles dont tu t'occupes). Les cadeaux déjà offerts descendent sous un trait, en bas : ils ne sont pas supprimés, c'est la mémoire de ce qui a déjà été offert.",
      "👀 Listes communes — la vue des invités reprend celle des wishlists : « Disponible » ou « Réservé », et un bouton pour réserver. Ils voyaient jusqu'ici les commandes des gestionnaires — statut, modification, suppression — qui échouaient toutes.",
      "🔑 ⚠️ Listes communes — le code d'accès garde désormais la porte du lien public : tant qu'il n'est pas saisi, les idées ne sont même pas envoyées. Le partage propose un lien qui embarque le code, pour ne pas avoir à l'envoyer dans un second message.",
      "📧 ⚠️ Listes communes — en réservant depuis le lien public, on peut laisser son email pour recevoir une confirmation et retrouver sa réservation depuis un autre appareil. Auparavant, changer de navigateur faisait tout perdre, et il suffisait de connaître un prénom pour défaire la réservation d'un autre.",
      "📂 ⚠️ Listes communes — le menu du profil donne accès aux listes que tu gères et à celles où tu es invité, ouvre directement sur la liste, et permet de la quitter.",
      "🃏 Les cartes des idées cadeaux s'alignent enfin : titre, occasion, prix et statut sont à la même hauteur d'une carte à l'autre, même sans prix ni image.",
      "📱 Dans les notifications, « Tout lire » et « Tout supprimer » chevauchaient le titre. Les en-têtes s'adaptent maintenant à la largeur de leurs boutons.",
      "📖 Guide d'utilisation et conditions d'utilisation à jour : annulation, transfert d'organisation, remboursement des cagnottes et leur coût, fonctionnement des listes communes.",
    ],
  },
  {
    version: "1.6.0",
